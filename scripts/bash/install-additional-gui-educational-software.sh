...
# Change '<channel name="xfce4-desktop" version="1.0">' to '<channel name="xfce4-desktop" version="1.0" locked="*" unlocked="root">'
# Change '<channel name="xfwm4" version="1.0">' to '<channel name="xfwm4" version="1.0" locked="*" unlocked="root">'
# Change '<channel name="xsettings" version="1.0">' to '<channel name="xsettings" version="1.0" locked="*" unlocked="root">'
