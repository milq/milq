...
Write-Host'Hello, world!'                   # Prints on screen: Hello, world!
Write-Host $x                               # Prints the variable x

#  You can print on screen strings and variables
Write-Host 'I have bought', $x, 'oranges and', $y, 'lemons.'
...
$height = '95.4'
$height.GetType(). fullname                          # Prints the current data type
$height = [double] $height                           # Convert a string to a real number
$height.GetType(). fullname 

$altitude = -544.432
$altitude.GetType(). fullname)
$altitude = [string] $height                         # Convert a real number to string
$altitude.GetType(). fullname)
